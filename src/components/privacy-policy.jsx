  ...
  return (
    <main>
      <section className="privacy-policy">
        ...
        <article className="privacy-policy-description">
          <h1 className="privacy-policy-title" >Datenschutz&shy;erkl&auml;rung</h1>
          ...
          <p>
            ...
            werden k&ouml;nnen. Details zum erweiterten Datenschutzmodus finden
            Sie hier:{" "}
            <a
